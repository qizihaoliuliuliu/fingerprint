...
//const u8* wifista_ssid="QQQ";			//路由器SSID号
//const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
//const u8* wifista_password="88888888"; 	//连接密码


const u8* wifista_ssid="231";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="19990503"; 	//连接密码

//WIFI AP模式,模块对外的无线参数,可自行修改.
const u8* wifiap_ssid="usr231";			//对外SSID号
...
//	Show_Str(30,90,200,16,"工作模式:",16,0);	//工作模式显示
	  Show_Str(30,650,200,16,"正在连接,请稍等...",12,0);
