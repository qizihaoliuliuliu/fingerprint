...
{        
	...
	//这行代码是什么意思？
		...
		/*加载指纹识别实验界面*/
	LCD_Fill(30,400+130,239,500+300,YELLOW);;
	POINT_COLOR=RED;
...
PRESTA:
	...
	//*******************************************************************
		if(netpro&0X01)     //TCP Client    透传模式测试
		{
			...
			{
					LCD_Fill(30,400+130,39,500+300,YELLOW);
					POINT_COLOR=RED;
						...
						{	
							...
							{		
								...
								{				
									...
									Show_Str_Mid(0,100,"刷指纹大成功",16,240);		
									
									str=mymalloc(SRAMIN,2000);
									sprintf((char*)p,"确有此人,ID:%d  匹配得分:%d",seach.pageID,seach.mathscore);
